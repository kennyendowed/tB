       ...
       {/* <aside className="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
         <div className="sidenav-header">
              ...
              <a className="navbar-brand m-0" target="_blank">
                   ...
                   <span className="ms-0 font-weight-bold">  <p className="centerText mb-5">FUTURE FORWARD BANKING</p></span>
               </a>
          </div>
           ...
           <div className="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
            ...
            <span className="nav-link-text ms-1">Dashboard</span>
             ...
             {currentUser.roleaccess.includes('fincon') && ( 
              <>
        <li className="nav-item">
 <Link to={"/BatchApproval"} className={location.pathname === '/BatchApproval' ? 'nav-link active':'nav-link'}>  
    <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
    <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"> 
         <title>BatchA-pproval</title>
        <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
    ...
    <span className="nav-link-text ms-1">Batch Approval</span>
  </Link>
</li>
