...
{/* <p>Sorry to inform , the accounts below for remapping to “${
   checkrecord[0].NewRm_Email.split("@")[0]
 }” with “RM code ${
checkrecord[0].newRMcode
} has been declined</p> */}

{/* <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="body" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #f6f6f6; width: 100%;" width="100%" bgcolor="#f6f6f6">
<tr>

<th style="font-family: sans-serif; font-size: 14px;  padding: 10px;  margin: 0 auto; border:1px solid black; background:#FDB813; color:#2E434E">Email Address</th>
<th style="font-family: sans-serif; font-size: 14px;  padding: 10px;  margin: 0 auto; border:1px solid black; background:#FDB813; color:#2E434E">Account Number</th>
<th style="font-family: sans-serif; font-size: 14px;  padding: 10px;  margin: 0 auto; border:1px solid black; background:#FDB813; color:#2E434E">Customer ID</th>
</tr>
...
// </td>
//                               <td align="left" style="font-family: sans-serif; font-size: 14px; margin: 0 auto;  padding-bottom: 15px; border:1px solid black;">    ${
//                                 rec.NewRm_Phone
//                               }            </td>
